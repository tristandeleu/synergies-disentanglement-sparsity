...
from figure_mcc_vs_noise_z import dict_x, dict_y, dict_label, dict_y_r
...
fig_mcc, axarr_mcc = plt.subplots(
    1, len(list_noise_scale)+ 1, sharex=False, sharey=True, figsize=figsize, constrained_layout=True)
...
for idx_cor, cor in enumerate(list_noise_scale):
    ...
    # bar_labels = ['0.01', '0.03', '0.1', '0.3', '1.0']
...
if save_fig:
    ...
    fig_name_r = '3dshape_influ_z_full_r_' + data
    fig_name_mcc = '3dshape_influ_z_full_mcc_' + data
    fig_r.savefig(
